...
class Bot:
    ...
    def cargar_animaciones(self, bot, scale):
        front = []
        back = []
        left = []
        right = []
        ...
        f1 = pygame.image.load(image_path + bot + 'f0.png')
        f2 = pygame.image.load(image_path + bot + 'f1.png')
        f3 = pygame.image.load(image_path + bot + 'f2.png')
        ...
        r1 = pygame.image.load(image_path + bot + 'r0.png')
        r2 = pygame.image.load(image_path + bot + 'r1.png')
        r3 = pygame.image.load(image_path + bot + 'r2.png')
        ...
        b1 = pygame.image.load(image_path + bot + 'b0.png')
        b2 = pygame.image.load(image_path + bot + 'b1.png')
        b3 = pygame.image.load(image_path + bot + 'b2.png')
        ...
        l1 = pygame.image.load(image_path + bot + 'l0.png')
        l2 = pygame.image.load(image_path + bot + 'l1.png')
        l3 = pygame.image.load(image_path + bot + 'l2.png')
